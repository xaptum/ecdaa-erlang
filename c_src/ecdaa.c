...
//
    ...
    uint8_t sig_buffer[ECDAA_SIGNATURE_FP256BN_LENGTH];

    // Write signature to binary
    ecdaa_signature_FP256BN_serialize(sig_buffer, &sig, basename_len != 0);
    if (ECDAA_SIGNATURE_FP256BN_LENGTH != sizeof(sig_buffer)) {
